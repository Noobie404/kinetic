                ...
                <div class="card-body">
                    <Form @submit="handleLogin" :validation-schema="schema">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <Field name="email" type="text" class="form-control" placeholder="Enter Email" autocomplete="email" required autofocus />
                        ...
                        <div class="form-group row login-input">
                            ...
                            <div class="col-md-6">
                                <Field name="password" :type="passwordFieldType" class="form-control" placeholder="Enter password" autocomplete="current-password" required/>
